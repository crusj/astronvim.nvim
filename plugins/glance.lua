...
return {
        ...
        config = function()
            ...
            maps.n["gD"] = { "<CMD>Glance definitions<CR>", desc = "[Glance] definitions" }
            maps.n["gR"] = { "<CMD>Glance references<CR>", desc = "[Glance] references" }
            maps.n["gY"] = { "<CMD>Glance type_definitions<CR>", desc = "[Glance] type_definitions" }
            maps.n["gI"] = { "<CMD>Glance implementations<CR>", desc = "[Glance] implementations" }
