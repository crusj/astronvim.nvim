...
return {
    "dnlhc/glance.nvim",
    keys = {
        { "gD", "<cmd>Glance definitions<CR>",      mode = { "n" }, desc = "[Glance] definitions" },
        { "gR", "<cmd>Glance references<CR>",       mode = { "n" }, desc = "[Glance] references" },
        { "gY", "<cmd>Glance type_definitions<CR>", mode = { "n" }, desc = "[Glance] type_definitions" },
        { "gI", "<cmd>Glance implementations<CR>",  mode = { "n" }, desc = "[Glance] implementations" },
    },
